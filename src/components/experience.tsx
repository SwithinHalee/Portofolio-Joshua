  ...
  return (
    <section id="experience" className="py-24 md:py-32 border-b border-[#EAEAEA]">
      <div className="mx-auto max-w-5xl px-6 sm:px-8">
        ...
        {/* Experience Timeline */}
        <div className="mb-16">
          <h3 className="font-mono text-xs uppercase tracking-wider text-[#787774] mb-6">
            {"// INDUSTRY ENGAGEMENT"}
          </h3>
            ...
            {EXPERIENCES.map((exp) => (
              ...
              >
                <div className="md:col-span-3 font-mono text-xs text-[#787774]">
                  ...
                  <div className="mt-1 text-[11px] text-[#999999]">{exp.location}</div>
                </div>
                ...
                <div className="md:col-span-9">
                  <div className="flex flex-wrap items-baseline gap-2 mb-2">
                    ...
                    <span className="text-sm font-medium text-[#111111]">{exp.company}</span>
                    <span className="rounded-full bg-[#EDF3EC] px-2 py-0.5 text-[10px] font-mono text-[#346538] border border-[#D5E8D4] ml-2">
                      {exp.type}
                    </span>
                  </div>
        ...
        <div>
          ...
          <div className="border-t border-[#EAEAEA] divide-y divide-[#EAEAEA]">
            {EDUCATION_HISTORY.map((edu) => (
              <div
                key={edu.institution}
                className="py-6 grid grid-cols-1 md:grid-cols-12 gap-6 items-start"
              >
                <div className="md:col-span-3 font-mono text-xs text-[#787774]">
                  {edu.period}
                </div>
