  ...
  return (
    <footer id="colophon" className="pt-24 pb-16 bg-[#FBFBFA]">
      <div className="mx-auto max-w-5xl px-6 sm:px-8">
        {/* Contact Directive */}
        <div id="contact" className="mb-20 rounded-[8px] border border-[#EAEAEA] bg-[#FFFFFF] p-8 sm:p-12">
          ...
          <p className="text-sm sm:text-base text-[#555555] max-w-2xl mb-8 leading-relaxed">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-[4px] bg-[#111111] px-5 py-3 text-xs font-mono text-white transition-colors hover:bg-[#2A2A2A]"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-[4px] border border-[#EAEAEA] bg-[#FBFBFA] px-5 py-3 text-xs font-mono text-[#111111] transition-colors hover:bg-[#F0F0EE]"
            >
              {copied ? (
                <>
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 rounded-[4px] border border-[#EAEAEA] bg-[#FFFFFF] px-4 py-3 text-xs font-mono text-[#111111] hover:bg-[#F7F6F3] transition-colors"
            >
